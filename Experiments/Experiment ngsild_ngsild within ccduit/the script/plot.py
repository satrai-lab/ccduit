...
def main():
    ...
    file_paths = [
        './Results/time_log_1.txt',
        './Results/time_log_2.txt',
        './Results/time_log_3.txt',
        './Results/time_log_4.txt',
        './Results/time_log_5.txt'
    ]
    ...
    plt.title('HTTP(NGSI-LD) to HTTP(NGSI-LD) within CCDUIT')
