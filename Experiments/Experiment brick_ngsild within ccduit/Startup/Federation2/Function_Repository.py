...
def convert_brick_to_ngsi_ld(ttl_data):
    ...
    # conversion_time = (time.time_ns() - start) / 1_000_000
    # print(f"Optimized conversion time: {conversion_time:.3f} ms for the converted data:")
    # print(json.dumps(ngsild_data,indent=2))
    return ngsild_data
